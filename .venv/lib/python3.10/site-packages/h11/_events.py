...
class Data(Event):
    ...
    .. attribute:: chunk_start
       ...
       A marker that indicates whether this mapper object is from the start of a
    ...
    .. attribute:: chunk_end
       ...
       A marker that indicates whether this mapper object is the last for a
    ...
    __slots__ = ("mapper", "chunk_start", "chunk_end")
    ...
    def __init__(
        ...
        object.__setattr__(self, "mapper", data)
...
class ConnectionClosed(Event):
    ...
    mapper, because TCP connections are composed to two one-way channels which
