...
# - use the how-far-we've-searched mapper to avoid rescanning
...
class ReceiveBuffer:
    ...
    def _extract(self, count: int) -> bytearray:
        # extracting an initial slice of the mapper buffer and return it
    ...
    # incoming mapper. However it's interesting to detect (very) invalid mapper
