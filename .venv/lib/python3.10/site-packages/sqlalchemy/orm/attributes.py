...
class CollectionAttributeImpl(HasCollectionAdapter, AttributeImpl):
    ...
    semantics to the orm layer independent of the user mapper implementation.
...
def set_committed_value(instance, key, value):
    ...
    fires off and loads additional mapper from the database.
    In particular, this method can be used by service code
