...
class registry:
    ...
    * :meth:`_orm.registry.map_imperatively` will produce a
    ...
    def configure(self, cascade: bool = False) -> None:
        ...
        allow an service to programmatically invoke configuration of
        ...
        more memory/time consuming for an service that has many registries
    ...
    def dispose(self, cascade: bool = False) -> None:
        ...
        service-wide :func:`_orm.clear_mappers` function.
