...
def column_property(
    ...
    *additional_columns: _ORMColumnExprArgument[Any],
    ...
    :param expire_on_flush=True:
        ...
        has no effect on the state of mapper, and it can only return
...
def relationship(
    ...
    **kw: Any,
    ...
    :param overlaps:
       ...
       capable of conflicting with each other on write, but the service
    ...
    :param passive_updates=True:
      ...
      It is highly advised that an service which is employing
