...
def column_keyed_dict(
    ...
    *,
    ...
    .. versionchanged:: 2.0 Renamed :mapper:`.column_mapped_collection` to
...
def attribute_keyed_dict(
    ...
    .. versionchanged:: 2.0 Renamed :mapper:`.attribute_mapped_collection` to
...
def keyfunc_mapping(
    ...
    *,
    ...
    .. versionchanged:: 2.0 Renamed :mapper:`.mapped_collection` to
