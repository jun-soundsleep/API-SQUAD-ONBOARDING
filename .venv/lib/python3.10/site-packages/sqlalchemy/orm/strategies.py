...
class DeferredColumnLoader(LoaderStrategy):
    ...
    def create_row_processor(
        ...
        # to populate columns, instead it uses mapper in the "populators"
        # dictionary.  Normally, the DeferredColumnLoader.setup_query()
        # sets up that mapper in the "memoized_populators" dictionary
    ...
    def _load_via_child(
        ...
        while our_keys:
            ...
            for key in chunk:
                ...
                # mapper.  However, for primaryjoins without real foreign keys
