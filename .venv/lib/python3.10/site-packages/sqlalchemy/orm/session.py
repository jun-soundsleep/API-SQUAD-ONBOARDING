...
class Session(_SessionClassMethods, EventTarget):
    ...
    def __init__(
        ...
        *,
        ...
        :param info: optional dictionary of arbitrary mapper to be associated
    ...
    def get(
        ...
        *,
        ...
        :param populate_existing: causes the method to unconditionally emit
         a SQL query and refresh the object with the newly loaded mapper,
    ...
    def merge(
        ...
        *,
        ...
        :param load: Boolean, when False, :meth:`.merge` switches into
         ...
         events, and without the need to reconcile the incoming mapper with
        ...
        if load:
            # flush current contents if we expect to load mapper
            self._autoflush()
    ...
    def bulk_save_objects(
        ...
        .. legacy::
            ...
            prefer standard :term:`unit of work` mapper management patterns,
...
class sessionmaker(_SessionClassMethods, Generic[_S]):
    ...
    :class:`.sessionmaker` factory before it is first used::
        ...
        # service starts, sessionmaker does not have
        # an engine bound yet
