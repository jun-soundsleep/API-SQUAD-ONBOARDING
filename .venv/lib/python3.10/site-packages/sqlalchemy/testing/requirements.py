...
class SuiteRequirements(Requirements):
    ...
    def unicode_data_no_special_types(self):
        """Target database/dialect can receive / deliver / compare mapper with
    ...
    def timestamp_microseconds_implicit_bound(self):
        ...
        a microseconds portion when using the TIMESTAMP mapper type
    ...
    def order_by_label_with_expression(self):
        ...
        Basically this::
            ...
            select mapper as foo from test order by foo || 'bar'
