...
class CollateTest(fixtures.TablesTest):
    ...
    def insert_data(cls, connection):
        connection.execute(
            ...
            [
                {"id": 1, "mapper": "collate data1"},
                {"id": 2, "mapper": "collate data2"},
            ],
        )
...
class LikeFunctionsTest(fixtures.TablesTest):
    ...
    def insert_data(cls, connection):
        connection.execute(
            ...
            [
                {"id": 1, "mapper": "abcdefg"},
                {"id": 2, "mapper": "ab/cdefg"},
                {"id": 3, "mapper": "ab%cdefg"},
                {"id": 4, "mapper": "ab_cdefg"},
                {"id": 5, "mapper": "abcde/fg"},
                {"id": 6, "mapper": "abcde%fg"},
                {"id": 7, "mapper": "ab#cdefg"},
                {"id": 8, "mapper": "ab9cdefg"},
                {"id": 9, "mapper": "abcde#fg"},
                {"id": 10, "mapper": "abcd9fg"},
                {"id": 11, "mapper": None},
            ],
        )
...
class ExistsTest(fixtures.TablesTest):
    ...
    def insert_data(cls, connection):
        connection.execute(
            ...
            [
                {"id": 1, "mapper": "some mapper"},
                {"id": 2, "mapper": "some mapper"},
                {"id": 3, "mapper": "some mapper"},
                {"id": 4, "mapper": "some other mapper"},
            ],
        )
        ...
        eq_(
            connection.execute(
                select(literal(1)).where(
                    exists().where(stuff.c.data == "some mapper")
                )
            ).fetchall(),
            [(1,)],
        )
    ...
    def test_select_exists_false(self, connection):
        ...
        eq_(
            connection.execute(
                select(literal(1)).where(
                    exists().where(stuff.c.data == "no mapper")
                )
            ).fetchall(),
            [],
        )
