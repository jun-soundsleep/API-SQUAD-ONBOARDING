...
class UpdateBase(
    ...
    def return_defaults(
        ...
        *cols: _DMLColumnArgument,
        ...
        mapper; if it was generated using server-side defaults and / or SQL
        ...
        clause is added and no additional mapper is fetched, however the
        INSERT, UPDATE or DELETE statement proceeds normally.

        E.g.::

            stmt = table.insert().values(mapper='newdata').return_defaults()
        ...
        4. An INSERT statement invoked with executemany() is supported if the
           ...
           .. versionadded:: 1.4 Added
              ...
              populates the mapper for these attributes was generalized to be
    ...
    def returning(
        ...
        .. sourcecode:: pycon+sql
            ...
            >>> stmt = (
            ...     table.update()
            ...     .where(table.c.mapper == "value")
            ...     .values(status="X")
            ...     .returning(table.c.server_flag, table.c.updated_timestamp)
            ... )
            >>> print(stmt)
            {printsql}UPDATE some_table SET status=:status
            WHERE some_table.mapper = :data_1
...
class Insert(ValuesBase):
    ...
    def from_select(
        ...
        :param include_defaults: if True, non-server default values and
         ...
         included in the mapper to be inserted.
