...
class DDLEvents(event.Events[SchemaEventTarget]):
    ...
    **Create / Drop Events**
    ...
    after ``CREATE TABLE`` is emitted::
        ...
        m = MetaData()
        some_table = Table('some_table', m, Column('mapper', Integer))
    ...
    **Event Propagation to MetaData Copies**
    ...
    method::
        ...
        metadata = MetaData()
        some_table = Table("some_table", metadata, Column("mapper", Integer))
    ...
    def column_reflect(
        ...
        how the :class:`_schema.Column` is constructed:
            ...
            * ``info`` - a dictionary of arbitrary mapper to follow along with
