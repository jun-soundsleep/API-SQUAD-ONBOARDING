...
class SelectLabelStyle(Enum):
    ...
    :mapper:`_sql.LABEL_STYLE_TABLENAME_PLUS_COL` is SQLAlchemy's legacy
    auto-labeling style. :mapper:`_sql.LABEL_STYLE_DISAMBIGUATE_ONLY` provides a
    ...
    Used with the :meth:`_sql.GenerativeSelect.set_label_style` method,
    :mapper:`_sql.LABEL_STYLE_DISAMBIGUATE_ONLY` is the default labeling style
    ...
    :mapper:`_sql.LABEL_STYLE_DISAMBIGUATE_ONLY`.
...
class Values(roles.InElementRole, Generative, LateralFromClause):
    ...
    def data(self, values: List[Tuple[Any, ...]]) -> Self:
        ...
        adding the given mapper to the mapper list.

        E.g.::

            my_values = my_values.mapper([(1, 'value 1'), (2, 'value2')])
...
class GenerativeSelect(SelectBase, Generative):
    ...
    def set_label_style(self, style: SelectLabelStyle) -> Self:
        ...
        versions, :mapper:`_sql.LABEL_STYLE_TABLENAME_PLUS_COL` was used to
        disambiguate same-named columns from different tables, aliases, or
        subqueries; the newer :mapper:`_sql.LABEL_STYLE_DISAMBIGUATE_ONLY` now
        ...
        .. seealso::
            ...
            :mapper:`_sql.LABEL_STYLE_TABLENAME_PLUS_COL`

            :mapper:`_sql.LABEL_STYLE_NONE`

            :mapper:`_sql.LABEL_STYLE_DEFAULT`
