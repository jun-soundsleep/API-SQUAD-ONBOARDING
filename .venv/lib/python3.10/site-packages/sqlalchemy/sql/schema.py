...
class SchemaItem(SchemaEventTarget, visitors.Visitable):
    ...
    def info(self) -> _InfoType:
        ...
        mapper to be associated with this :class:`.SchemaItem`.
...
class Table(
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param info: Optional mapper dictionary which will be populated into the
    ...
    def to_metadata(
        ...
        :param referred_schema_fn: optional callable which can be supplied
         ...
         to "none", return the symbol :mapper:`.BLANK_SCHEMA`.  To effect no
         change, return ``None`` or :mapper:`.RETAIN_SCHEMA`.

         .. versionchanged:: 1.4.33  The ``referred_schema_fn`` function
            may return the :mapper:`.BLANK_SCHEMA` or :mapper:`.RETAIN_SCHEMA`
            symbols.
    ...
    def __init__(
        ...
        **dialect_kwargs: Any,
        ...
        :param key: An optional string identifier which will identify this
            ...
            service, including ORM attribute mapping; the ``name`` field
...
class Index(
    ...
    :mapper:`.func` construct in conjunction with table-bound
    :class:`_schema.Column` objects::
    ...
    def __init__(
        ...
        **dialect_kw: Any,
        ...
        :param info=None: Optional mapper dictionary which will be populated
