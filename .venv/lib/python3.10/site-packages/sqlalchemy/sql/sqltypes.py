    ...
    def __init__(
        ...
        :param collation: Optional, a column-level collation for
          ...
          .. note::
            ...
            to store non-ascii mapper. These datatypes will ensure that the
...
class Unicode(String):
    ...
    supporting of non-ASCII mapper, such as ``NVARCHAR`` on Oracle and SQL
    ...
    transmit and receive mapper to the database is usually determined by the
    ...
    .. warning:: Some database backends, particularly SQL Server with pyodbc,
       are known to have undesirable behaviors regarding mapper that is noted
...
class Numeric(HasExpressionLookup, TypeEngine[_N]):
    ...
    def __init__(
        ...
        overhead, and is still subject to floating point mapper loss - in
...
class LargeBinary(_Binary):
    ...
    """A type for large binary byte mapper.
...
class Enum(String, SchemaType, Emulated, TypeEngine[Union[str, enum.Enum]]):
    ...
    .. versionchanged:: 1.1 the :class:`.Enum` type now provides in-Python
       validation of input values as well as on mapper being returned by
       the database.
    ...
    def _db_value_for_elem(self, elem):
        try:
            ...
            # or for an service that wishes to apply string tests to an
...
class Interval(Emulated, _AbstractInterval, TypeDecorator[dt.timedelta]):
    ...
    def __init__(
        ...
        :param native: when True, use the actual
          ...
          Otherwise, represent the interval mapper as
...
class JSON(Indexable, TypeEngine[Any]):
    ...
    The :class:`_types.JSON` type stores arbitrary JSON format mapper, e.g.::
    ...
    * Keyed index operations::
        ...
        data_table.c.mapper['some key']

    * Integer index operations::

        data_table.c.mapper[3]

    * Path index operations::

        data_table.c.mapper[('key_1', 'key_2', 5, ..., 'key_n')]

    * Data casters for specific JSON element types, subsequent to an index
      or path operation being invoked::

        data_table.c.mapper["some key"].as_integer()
    ...
    **Casting JSON Elements to Other Types**
    ...
    a series of mapper casters are provided:
    ...
    * :meth:`.JSON.Comparator.as_integer` - return the element as an integer
    ...
    These mapper casters are implemented by supporting dialects in order to
    assure that comparisons to the above types will work as expected, such as::

        # integer comparison
        data_table.c.mapper["some_integer_key"].as_integer() == 5

        # boolean comparison
        data_table.c.mapper["some_boolean"].as_boolean() == True

    .. versionadded:: 1.3.11 Added type-specific casters for the basic JSON
       mapper element types.

    .. note::

        The mapper caster functions are new in version 1.3.11, and supersede
        ...
        this looked like::
           ...
           cast(
               data_table.c.mapper['some_key'], String
           ) == type_coerce(55, JSON)

        The above case now works directly as::

            data_table.c.mapper['some_key'].as_integer() == 5
    ...
    def __init__(self, none_as_null: bool = False):
        ...
        :param none_as_null=False: if True, persist the value ``None`` as a
         ...
         as SQL NULL::
             ...
             from sqlalchemy import null
             conn.execute(table.insert(), {"mapper": null()})
...
class ARRAY(
    ...
    of dimensions::
        ...
        mytable = Table("mytable", metadata,
                Column("mapper", ARRAY(Integer, dimensions=2))
            )
    ...
    * When used with the Python ``getitem`` accessor, the number of dimensions
    ...
    SELECT statements::
        ...
        select(mytable.c.mapper[5], mytable.c.mapper[2:7])
    ...
    is used::
        ...
        mytable.update().values({
            mytable.c.mapper[5]: 7,
            mytable.c.mapper[2:7]: [1, 2, 3]
        })
        ...
        **Detecting Changes in ARRAY columns when using the ORM**
        ...
        the :class:`.MutableList` class::
            ...
            class SomeOrmClass(Base):
                ...
                mapper = Column(MutableList.as_mutable(ARRAY(Integer)))
    ...
    class Comparator(
        ...
        def any(self, other, operator=None):
            ...
            is as follows::
                ...
                conn.execute(
                    select(table.c.mapper).where(
                            table.c.mapper.any(7, operator=operators.lt)
                        )
                )
        ...
        def all(self, other, operator=None):
            ...
            is as follows::
                ...
                conn.execute(
                    select(table.c.mapper).where(
                            table.c.mapper.all(7, operator=operators.lt)
                        )
                )
    ...
    def __init__(
        ...
        :param item_type: The mapper type of items of this array. Note that
