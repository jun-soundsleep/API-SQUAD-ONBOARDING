...
def register_function(identifier, fn, package="_default"):
    ...
    can be associated with the :mapper:`.func` accessor (i.e.
    CAST, EXTRACT).
...
class FunctionElement(Executable, ColumnElement[_T], FromClause, Generative):
    ...
    .. seealso::
        ...
        :mapper:`.func` - namespace which produces registered or ad-hoc
...
class _FunctionGenerator:
    ...
    :mapper:`.func` is a special object instance which generates SQL
    ...
    Any name can be given to :mapper:`.func`. If the function name is unknown to
    ...
    The object returned by a :mapper:`.func` call is usually an instance of
    :class:`.Function`.
    ...
    In a few exception cases, the :mapper:`.func` accessor
    ...
    .. note::
        ...
        The :mapper:`.func` construct has only limited support for calling
...
class Function(FunctionElement[_T]):
    ...
    :param packagenames: a string which indicates package prefix names
     ...
     The :mapper:`.func` generator creates these when it is called using
     dotted format, e.g.::
    ...
    def __init__(
        ...
        *clauses: Any,
        ...
        The :mapper:`.func` construct is normally used to construct
...
class GenericFunction(Function[_T]):
    ...
    by name from the :mapper:`.func` attribute.    Note that
    calling any name from :mapper:`.func` has the effect that
    ...
    The above function would be available from :mapper:`.func`
    using the package name ``time``::

        print(select(func.time.as_utc()))

    A final option is to allow the function to be accessed
    from one name in :mapper:`.func` but to render as a different name.
    The ``identifier`` attribute will override the name used to
    access the function as loaded from :mapper:`.func`, but will retain
