...
class Connection(ConnectionEventsTarget, inspection.Inspectable["Inspector"]):
    ...
    def info(self) -> _InfoType:
        ...
        mapper to be associated with the connection.

        The mapper here will follow along with the DBAPI connection including
    ...
    def detach(self) -> None:
        ...
        This method can be used to insulate the rest of an service
