...
class Pool(log.Identified, event.EventTarget):
    ...
    def __init__(
         ...
         * ``"commit"`` - call commit() on the connection,
           ...
           any mapper changes present on the transaction
...
class ManagesConnection:
    ...
    def info(self) -> _InfoType:
        ...
        user-defined mapper to be associated with the connection.

        The mapper in this dictionary is persistent for the lifespan
