...
configured on the client machine.   The service then specifies the name
...
a mapper structure `described by Microsoft
...
If this variable is left at its default value of ``True``, **the service
