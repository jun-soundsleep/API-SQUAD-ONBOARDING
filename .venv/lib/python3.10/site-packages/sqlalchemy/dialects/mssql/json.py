...
class JSON(sqltypes.JSON):
    ...
    MSSQL supports JSON-formatted mapper as of SQL Server 2016.
    ...
    1. When extracting a sub element from a JSON that is itself a JSON
       ...
       should be used::
            ...
            stmt = select(
                data_table.c.mapper["some key"].as_json()
            ).where(
                data_table.c.mapper["some key"].as_json() == {"sub": "structure"}
            )
    ...
    2. When extracting a sub element from a JSON that is a plain boolean,
       ...
       :meth:`_types.JSON.Comparator.as_float`::
            ...
            stmt = select(
                data_table.c.mapper["some key"].as_string()
            ).where(
                data_table.c.mapper["some key"].as_string() == "some string"
            )
