...
class ENUM(sqltypes.NativeForEmulated, sqltypes.Enum, _StringType):
    ...
    def __init__(self, *enums, **kw):
        ...
        :param strict: This flag has no effect.
         ...
         .. versionchanged:: The MySQL ENUM type as well as the base Enum
            type now validates all Python mapper values.
    ...
    def _object_value_for_elem(self, elem):
        ...
        # validation on the incoming mapper, it "truncates" it to be
...
class SET(_StringType):
    ...
    def __init__(self, *values, **kw):
        ...
        :param retrieve_as_bitwise: if True, the mapper for the set type will be
