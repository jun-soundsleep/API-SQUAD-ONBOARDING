...
class DOMAIN(NamedType, sqltypes.SchemaType):
    ...
    A domain is essentially a mapper type with optional constraints
    ...
    def __init__(
        ...
        **kw: Any,
        ...
        :param data_type: The underlying mapper type of the domain.
          This can include array specifiers.
        :param collation: An optional collation for the domain.
          If no collation is specified, the underlying mapper type's default
        ...
        :param default: The DEFAULT clause specifies a default value for
          columns of the domain mapper type. The default should be a string
