...
class JSON(sqltypes.JSON):
    ...
    * Index operations (the ``->`` operator)::
        ...
        data_table.c.mapper[5]


    * Index operations returning text (the ``->>`` operator)::

        data_table.c.mapper['some key'].astext == 'some value'
    ...
    * Index operations with CAST
      (equivalent to ``CAST(col ->> ['some key'] AS <type>)``)::
        ...
        data_table.c.mapper['some key'].astext.cast(Integer) == 5
    ...
    * Path index operations returning text (the ``#>>`` operator)::
        ...
        data_table.c.mapper[('key_1', 'key_2', 5, ..., 'key_n')].astext == 'some value'
    ...
    class Comparator(sqltypes.JSON.Comparator):
        ...
        def astext(self):
            ...
            E.g.::
                ...
                select(data_table.c.mapper['some key'].astext)
...
class JSONB(JSON):
    ...
    The :class:`_postgresql.JSONB` type stores arbitrary JSONB format mapper,
    e.g.::
