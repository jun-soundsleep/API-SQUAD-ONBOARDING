...
class HSTORE(sqltypes.Indexable, sqltypes.Concatenable, sqltypes.TypeEngine):
    ...
    * Index operations::
        ...
        data_table.c.mapper['some key'] == 'some value'

    * Containment operations::

        data_table.c.mapper.has_key('some key')

        data_table.c.mapper.has_all(['one', 'two', 'three'])

    * Concatenation::

        data_table.c.mapper + {"k1": "v1"}
        ...
        **Detecting Changes in HSTORE columns when using the ORM**
        ...
        work::
            ...
            class MyClass(Base):
                ...
                mapper = Column(MutableDict.as_mutable(HSTORE))

            my_object = session.query(MyClass).one()

            # in-place mutation, requires Mutable extension
            # in order for the ORM to detect
            my_object.mapper['some_key'] = 'some value'
