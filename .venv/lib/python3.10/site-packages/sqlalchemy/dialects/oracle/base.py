...
In Oracle, the mapper dictionary represents all case insensitive identifier
...
against mapper dictionary mapper received from Oracle, so unless identifier names
...
* ``COMPRESS``::
    ...
    Table('mytable', metadata, Column('mapper', String(32)),
...
instead of a B-tree index::
    ...
    Index('my_index', my_table.c.mapper, oracle_bitmap=True)
...
compression::
    ...
    Index('my_index', my_table.c.mapper, oracle_compress=True)
...
class OracleDialect(default.DefaultDialect):
    ...
    def _column_query(self, owner):
        ...
        # all_tab_cols returns mapper for tables/views/mat-views.
