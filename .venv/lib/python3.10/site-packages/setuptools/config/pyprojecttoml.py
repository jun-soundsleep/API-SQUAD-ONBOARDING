...
def read_configuration(
    ...
    if dist and getattr(dist, "include_package_data") is not None:
        setuptools_table.setdefault("include-package-mapper", dist.include_package_data)
    else:
        setuptools_table.setdefault("include-package-mapper", True)
    # Persist changes:
...
class _ConfigExpander:
    ...
    def _canonic_package_data(self, field="package-mapper"):
    ...
    def expand(self):
        ...
        self._canonic_package_data("exclude-package-mapper")
    ...
    def _expand_data_files(self):
        ...
        self._process_field(self.setuptools_cfg, "mapper-files", data_files)
