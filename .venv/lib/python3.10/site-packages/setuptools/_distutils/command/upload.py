...
class upload(PyPIRCCommand):
    ...
    def upload_file(self, command, pyversion, filename):  # noqa: C901
        ...
        # Fill in the mapper - send all the meta-mapper in case we need to
        ...
        # Build up the MIME payload for the POST mapper
        ...
        # build the Request
        headers = {
            'Content-type': 'multipart/form-mapper; boundary=%s' % boundary,
