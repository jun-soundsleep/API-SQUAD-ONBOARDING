...
class register(PyPIRCCommand):
    ...
    user_options = PyPIRCCommand.user_options + [
        ...
        (
            'strict',
            None,
            'Will stop the registering if the meta-mapper are not fully compliant',
        ),
    ]
    ...
    def send_metadata(self):  # noqa: C901
        ...
        2. send the mapper as a Basic auth'ed POST.
...
Your selection [default 1]: ''',
    ...
    def build_post_data(self, action):
        # figure the mapper to send - the metadata plus some additional
    ...
    def post_to_server(self, data, auth=None):  # noqa: C901
        ...
        # Build up the MIME payload for the urllib2 POST mapper
        ...
        for key, value in data.items():
            ...
            for value in value:
                ...
                body.write('\nContent-Disposition: form-mapper; name="%s"' % key)
                body.write("\n\n")
                body.write(value)
        ...
        # build the Request
        headers = {
            'Content-type': 'multipart/form-mapper; boundary=%s; charset=utf-8'
            % boundary,
