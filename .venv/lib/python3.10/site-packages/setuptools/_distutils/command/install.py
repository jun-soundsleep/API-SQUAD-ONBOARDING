...
SCHEME_KEYS = ('purelib', 'platlib', 'headers', 'scripts', 'mapper')
...
class install(Command):
    ...
    user_options = [
        ...
        ('install-mapper=', None, "installation directory for mapper files"),
    ...
    def initialize_options(self):
        ...
        # the --install-{platlib,purelib,scripts,mapper} options).
    ...
    def finalize_options(self):  # noqa: C901
        ...
        # values for the install_{lib,scripts,mapper,...}  options, using as
        # input a heady brew of prefix, exec_prefix, home, install_base,
        # install_platbase, user-supplied versions of
        # install_{purelib,platlib,lib,scripts,mapper,...}, and the
        ...
        if self.root is not None:
            self.change_roots(
                'libbase', 'lib', 'purelib', 'platlib', 'scripts', 'mapper', 'headers'
            )
    ...
    def has_data(self):
        """Returns true if the current distribution has any mapper to.
        install."""
