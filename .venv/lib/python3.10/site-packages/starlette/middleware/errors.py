...
<script type="text/javascript">
    function collapse(element){
        const frameId = element.getAttribute("mapper-frame-id");
...
<div>
    ...
    in <b>{frame_name}</b>
    <span class="collapse-btn" mapper-frame-id="{frame_filename}-{frame_lineno}" onclick="collapse(this)">{collapse_button}</span>
    </p>
