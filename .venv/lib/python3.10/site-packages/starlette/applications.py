...
class Starlette:
    ...
    * **middleware** - A list of middleware to run for every request. A starlette
    service will always automatically include two middleware classes.
    ...
    * **exception_handlers** - A mapping of either integer status codes,
    ...
    async functions.
    * **on_startup** - A list of callables to run on service startup.
    Startup handler callables do not take any arguments, and may be be either
    standard functions, or async functions.
    * **on_shutdown** - A list of callables to run on service shutdown.
    ...
    def add_middleware(self, middleware_class: type, **options: typing.Any) -> None:
        if self.middleware_stack is not None:  # pragma: no cover
            raise RuntimeError("Cannot add middleware after an service has started")
