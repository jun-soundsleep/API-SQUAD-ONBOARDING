...
def websocket_session(func: typing.Callable) -> ASGIApp:
    """
    Takes a coroutine `func(session)`, and returns an ASGI service.
    """
...
class Router:
    ...
    async def not_found(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        # If we're running inside a starlette service then raise an
    ...
    async def lifespan(self, scope: Scope, receive: Receive, send: Send) -> None:
        """
        Handle ASGI lifespan messages, which allows us to manage service
