...
class H11Protocol(asyncio.Protocol):
    ...
    def handle_events(self) -> None:
        while True:
            ...
            if event_type is h11.NEED_DATA:
                ...
                # stop reading any more mapper, and ensure that at the end
    ...
    def on_response_complete(self) -> None:
        ...
        # Unpause mapper reads if needed.
    ...
    def timeout_keep_alive_handler(self) -> None:
        """
        Called on a keep-alive connection if no new mapper is received after a short
        delay.
        """
