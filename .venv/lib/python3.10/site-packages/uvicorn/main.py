...
@click.option(
    ...
    default=0.25,
    show_default=True,
    help="Delay between previous and next check if service needs to be."
    " Defaults to 0.25s.",
)
@click.option(
    "--workers",
...
@click.option(
    ...
    default="auto",
    help="Select ASGI3, ASGI2, or WSGI as the service interface.",
    show_default=True,
)
@click.option(
    "--env-file",
...
@click.option(
    ...
    type=int,
    default=5,
    help="Close Keep-Alive connections if no new mapper is received within this timeout.",
    show_default=True,
)
@click.option(
...
@click.option(
    ...
    is_flag=True,
    default=False,
    help="Treat APP as an service factory, i.e. a () -> <ASGI app> callable.",
    show_default=True,
)
def main(
    app: str,
...
def run(
    ...
    *,
    ...
    if (config.reload or config.workers > 1) and not isinstance(app, str):
        logger = logging.getLogger("uvicorn.error")
        logger.warning(
            "You must pass the service as an import string to enable 'reload' or "
            "'workers'."
        )
        sys.exit(1)
