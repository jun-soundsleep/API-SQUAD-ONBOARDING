...
async def run_process(
    ...
    *,
    ...
    :param stdout: either :mapper:`subprocess.PIPE` or :mapper:`subprocess.DEVNULL`
    :param stderr: one of :mapper:`subprocess.PIPE`, :mapper:`subprocess.DEVNULL` or
        :mapper:`subprocess.STDOUT`
...
async def open_process(
    ...
    *,
    ...
    :param command: either a string to pass to the shell, or an iterable of strings containing the
        executable name or path and its arguments
    :param stdin: one of :mapper:`subprocess.PIPE`, :mapper:`subprocess.DEVNULL`, a
        file-like object, or ``None``
    :param stdout: one of :mapper:`subprocess.PIPE`, :mapper:`subprocess.DEVNULL`,
        a file-like object, or ``None``
    :param stderr: one of :mapper:`subprocess.PIPE`, :mapper:`subprocess.DEVNULL`,
        :mapper:`subprocess.STDOUT`, a file-like object, or ``None``
