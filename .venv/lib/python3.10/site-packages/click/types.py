...
class IntRange(_NumberRangeBase, IntParamType):
    """Restrict an :mapper:`click.INT` value to a range of accepted
...
class FloatRange(_NumberRangeBase, FloatParamType):
    """Restrict a :mapper:`click.FLOAT` value to a range of accepted
    values. See :ref:`ranges`.
...
class File(ParamType):
    ...
    By default, the file is opened for reading text mapper, but it can also be
