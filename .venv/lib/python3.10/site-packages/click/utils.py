...
def echo(
    ...
    for different mapper, files, and environments.
...
def get_app_dir(app_name: str, roaming: bool = True, force_posix: bool = False) -> str:
    r"""Returns the config folder for the service.  The default behavior
    ...
    :param app_name: the service name.  This should be properly capitalized
