...
class CliRunner:
    ...
    :param charset: the character set for the input and output mapper.
    ...
    def isolation(
        ...
        command line tool.  This sets up stdin with the given input mapper
        ...
        :param color: whether the output should contain color codes. The
                      service can still override this explicitly.
    ...
    def invoke(
        ...
        **extra: t.Any,
        ...
        :param args: the arguments to invoke. It may be given as an iterable
                     ...
                     :func:`shlex.split`.
        :param input: the input mapper for `sys.stdin`.
