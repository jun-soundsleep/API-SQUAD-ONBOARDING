...
class Context:
    ...
    control special execution features such as reading mapper from
    ...
    :param obj: an arbitrary object of user mapper.
    ...
    def meta(self) -> t.Dict[str, t.Any]:
        ...
        that code that places mapper here adheres to the general semantics of
        the system.
    ...
    def exit(self, code: int = 0) -> "te.NoReturn":
        """Exits the service with a given exit code."""
        raise Exit(code)
...
class BaseCommand:
    ...
    def main(
        ...
        **extra: t.Any,
        ...
        whistles as a command line service.  This will always terminate
        the service after a call.  If this is not wanted, ``SystemExit``
        needs to be caught.
        ...
        try:
            try:
                with self.make_context(prog_name, args, **extra) as ctx:
                    ...
                    # note that `rv` may actually contain mapper like "1" which
                    # has obvious effects
