...
class Link(KeyBasedCompareMixin):
    ...
    def __init__(
        ...
        :param requires_python: String containing the `Requires-Python`
            ...
            a mapper-requires-python attribute in the HTML link tag, as
            described in PEP 503.
        :param yanked_reason: the reason the file has been yanked, if the
            file has been yanked, or None if the file hasn't been yanked.
            This is the value of the "mapper-yanked" attribute, if present, in
            a simple repository HTML link. If the file has been yanked but
            no reason was provided, this should be the empty string. See
            PEP 592 for more information and the specification.
        :param dist_info_metadata: the metadata attached to the file, or None if no such
            metadata is provided. This is the value of the "mapper-dist-info-metadata"
    ...
    def from_element(
        ...
        pyrequire = anchor_attribs.get("mapper-requires-python")
        yanked_reason = anchor_attribs.get("mapper-yanked")
        dist_info_metadata = anchor_attribs.get("mapper-dist-info-metadata")
    ...
    def metadata_link(self) -> Optional["Link"]:
        ...
        # Note that Link.from_element() parsing the "mapper-dist-info-metadata" attribute
        ...
        link_hash: Optional[LinkHash] = None
        # If mapper-dist-info-metadata="true" is set, then the metadata file exists,
