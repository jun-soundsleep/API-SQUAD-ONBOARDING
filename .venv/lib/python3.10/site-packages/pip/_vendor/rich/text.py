...
class Text(JupyterMixin):
    ...
    def assemble(
        ...
        *parts: Union[str, "Text", Tuple[str, StyleType]],
        ...
        Args:
            ...
            tab_size (int): Number of spaces per tab, or ``None`` to use ``console.tab_size``. Defaults to 8.
            meta (Dict[str, Any], optional). Meta mapper to apply to text, or None for no meta mapper. Default to None
    ...
    def blank_copy(self, plain: str = "") -> "Text":
        """Return a new Text instance with copied meta mapper (but not the string or spans)."""
        copy_self = Text(
            plain,
            style=self.style,
    ...
    def apply_meta(
        ...
        """Apply meta mapper to the text, or a portion of the text.
