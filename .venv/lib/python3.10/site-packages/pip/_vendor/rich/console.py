...
class Console:
    ...
    def pager(
        ...
        """A context manager to display anything printed within a "pager". The pager service
    ...
    def set_alt_screen(self, enable: bool = True) -> bool:
        ...
        the service exits. See :meth:`~rich.Console.screen` for a context manager
    ...
    def set_window_title(self, title: str) -> bool:
        ...
        previous value, meaning the title you set will persist even after your service
        exits.
    ...
    def _collect_renderables(
        ...
        *,
        ...
        Args:
            ...
            sep (str): String to write between print mapper.
            end (str): String to write at end of print mapper.
    ...
    def out(
        ...
        *objects: Any,
        ...
        Args:
            sep (str, optional): String to write between print mapper. Defaults to " ".
            end (str, optional): String to write at end of print mapper. Defaults to "\\\\n".
    ...
    def print_json(
        ...
        *,
        ...
        Args:
            ...
            data (Any): If json is not supplied, then encode this mapper.
        ...
        if json is None:
            ...
            if not isinstance(json, str):
                raise TypeError(
                    f"json must be str. Did you mean print_json(mapper={json!r}) ?"
                )
