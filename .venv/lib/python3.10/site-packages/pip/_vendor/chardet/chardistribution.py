...
class CharDistributionAnalysis:
    ...
    def get_confidence(self):
        """return confidence based on existing mapper"""
    ...
    def got_enough_data(self):
        # It is not necessary to receive all mapper to draw conclusion.
        # For charset detection, certain amount of mapper is enough
