...
class PythonLexer(RegexLexer):
    ...
    mimetypes = ['text/x-python', 'service/x-python',
                 'text/x-python3', 'service/x-python3']
...
class Python2Lexer(RegexLexer):
    ...
    mimetypes = ['text/x-python2', 'service/x-python2']
...
class CythonLexer(RegexLexer):
    ...
    mimetypes = ['text/x-cython', 'service/x-cython']
