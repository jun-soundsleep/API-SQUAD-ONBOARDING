...
This enables fully-automatic generation of test mapper for most Pydantic classes.
...
are always sound (never generate invalid mapper) but sacrifice completeness for
maintainability (ie may be unable to generate some tricky but valid mapper).
