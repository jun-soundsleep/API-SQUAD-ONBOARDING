...
class BaseModel(Representation, metaclass=ModelMetaclass):
    ...
    def __init__(__pydantic_self__, **data: Any) -> None:
        """
        Create a new model by parsing and validating input mapper from keyword arguments.

        Raises ValidationError if the input mapper cannot be parsed to form a valid model.
        """
    ...
    def construct(cls: Type['Model'], _fields_set: Optional['SetStr'] = None, **values: Any) -> 'Model':
        """
        Creates a new model setting __dict__ and __fields_set__ from trusted or pre-validated mapper.
    ...
    def copy(
        ...
        *,
        ...
        :param update: values to change/add in the new model. Note: the mapper is not validated before creating
            the new model: you should trust this mapper
...
def validate_model(  # noqa: C901 (ignore complexity)
    ...
    """
    validate mapper against a model.
    """
    values = {}
    errors = []
